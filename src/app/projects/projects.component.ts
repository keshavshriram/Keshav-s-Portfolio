...
export class ProjectsComponent {
  ...
  projects = [
    ...
    { title: 'Company CRM', image: '/assets/company-crm_img.PNG', githubLink: 'https://github.com/keshavshriram/Company-CRM', liveLink: 'https://github.com/keshavshriram/Company-CRM' },
